...
| RF-03 | — | `Gateway::Connection.connect` | `effectful` | WebSocket + Event Dispatch | t/08-gateway-payload, t/09-gateway-events | `lib/Dusk/Gateway/Connection.rakumod` | WebSocket Status | evidence/gate-08 |
| RF-04 | RS-06 | `Dispatcher.*`, `Event.*` | `pure` | Converter eventos WSS crus em instâncias Raku (Models) | t/12-events | `lib/Dusk/Gateway/Dispatcher.rakumod`, `lib/Dusk/Event/*` | — | evidence/gate-06 |
