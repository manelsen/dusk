...
method on-guild-member-update(--> Supply)    { self.on('GUILD_MEMBER_UPDATE').map( { Dusk::Event::Events::GuildMemberAdd.new(raw => $_) }) } # Use MemberAdd class as it is compatible
